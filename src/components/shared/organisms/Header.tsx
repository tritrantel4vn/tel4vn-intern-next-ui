...
import Notifications from "@/src/components/dropdown-notifications";
import DropdownHelp from "@/src/components/dropdown-help";
import ThemeToggle from "@/src/components/theme-toggle";
import DropdownProfile from "@/src/components/dropdown-profile";

const Header = ({ variant = "default" }: { variant?: "default" | "v2" | "v3" }) => {
