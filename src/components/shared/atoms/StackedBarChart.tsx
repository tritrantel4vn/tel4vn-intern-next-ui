...
const StackedBarChart = memo(
	({ data, width, height, isLoading, timeScaleTimeOptions }: StackedBarChartProps) => {
				...
				options: {
					...
					plugins: {
						...
						tooltip: {
							...
							bodyColor: theme === "dark" ? tooltipBodyColor.dark : tooltipBodyColor.light,
							backgroundColor: theme === "dark" ? tooltipBgColor.dark : tooltipBgColor.light,
							borderColor: theme === "dark" ? tooltipBorderColor.dark : tooltipBorderColor.light,
						},
					},
					interaction: {
						intersect: false,
		...
		}, [data, isLoading, timeScaleTimeOptions]);
